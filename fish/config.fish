...
function g --wraps=git
    /mnt/c/Program\ Files/Git/bin/git.exe $argv
end
alias gd='TMPDIR=tmp g difftool'
alias gitmerge='TMPDIR=tmp g mergetool --tool=meld'
#alias gdm='TMPDIR=tmp git difftool --tool=matlab'
#alias gitmergem='TMPDIR=tmp git mergetool --tool=matlab'
alias gdbc='TMPDIR=tmp g difftool --tool=bc'
#alias clearoxygen='\
